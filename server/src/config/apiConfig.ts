...
export const AZURE_OPENAI_ENDPOINT = 'https://lumenia.openai.azure.com'; // Azure OpenAI endpoint
export const AZURE_OPENAI_DEPLOYMENT_GPT_4 = 'gpt-4'; // this must match your deployed model name
export const AZURE_OPENAI_DEPLOYMENT_TEXT_EMBEDDING_ADA_002 = 'text-embedding-ada-002'; // this must match your deployed model name
