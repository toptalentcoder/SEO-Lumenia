...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'seo-guides': SeoGuidesSelect<false> | SeoGuidesSelect<true>;
...
export interface SeoGuide {
  ...
  optimizationLevels?:
    | {
        ...
        optimizationRanges?: {
          name?: string | null;
          subOptimized?: number | null;
          standardOptimized?: number | null;
          strongOptimized?: number | null;
          overOptimized?: number | null;
        };
        id?: string | null;
      }[]
    | null;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'seo-guides';
        value: string | SeoGuide;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "seo-guides_select".
 */
export interface SeoGuidesSelect<T extends boolean = true> {
  project?: T;
  query?: T;
  queryID?: T;
  queryEngine?: T;
